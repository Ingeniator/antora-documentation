...
Описание назначения/возможностей/решаемых задач - для клиентов!
...
To create a cross reference *to the latest version of this page from a page in Component A*, the xref syntax would be `\xref:home::index.adoc[]`.

=== Target a specific version of this page

To create a cross reference *to version 1.0 of this page from a page in Component A*, the xref syntax would be `\xref:1.0@home::index.adoc[]`.
